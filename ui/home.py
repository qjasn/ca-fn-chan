...
class HomePage:
    ...
    def __init__(self, page, element):
        ...
        self.page = page
        self.ui = Column(controls=[])
        self.value = "f"
        self.name = TextField(label="Name", value=self.value, width=70)
    ...
    def show_bs(self, e):
        ...
        if not _value:
            ...
            for a in _f_n:
                print(_f_n)
                UString.f_n.append("{}{}".format(a, UString.t))
        _value = list(set(UString.f_n) - set(UString.a_e))
        print(UString.f_n)
        self.value = _value[0]
        self.name = TextField(label="Name", value=self.value, width=70)
        ...
        for i in self.lists:
            ...
            self.ui.controls.append(
                EquationUI(name=i["name"], args=i["args"], text="return {}".format(i["text"]),
                           page=self.page).create_ui(i, self.equals))
        return self.ui
